  ...
  return (
    <RoleGuard>
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-amber-950/30">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="glass-card rounded-2xl p-5">
            ...
            <p className="text-2xl font-bold text-amber-400">₹ 89,200</p>
          ...
          <div className="glass-card rounded-2xl p-5">
            ...
            <p className="text-2xl font-bold text-blue-400">14 Intimations</p>
